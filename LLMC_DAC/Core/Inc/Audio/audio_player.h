...
#define FS_FIFO_SIZE  128U * 1024U // 64KBytes
...
extern uint8_t memFileDecoder1[SIZE_MEMPOOL_FILE_DECODER_1];
extern uint8_t memFileDecoder2[SIZE_MEMPOOL_FILE_DECODER_2];
typedef enum
{
