...
/**
  ...
  * @retval None
  */
static uint8_t __attribute__((section(".ITCMRAM_isr_vector"))) isr_vector_RAM[0x400];
...
//	while(1);
 ...
 __IO uint32_t tmpreg;
  ...
  RCC->CR &= 0xEAF6ED7FU; // NOTE: turn off HSE will halt QSPI Flash, how to resolve it??
