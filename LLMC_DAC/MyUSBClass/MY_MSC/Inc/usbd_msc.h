...
/* MSC Class Config */
#define USBD_MAX_NUM_INTERFACES_MSC 1U
#define MSC_MEDIA_PACKET             4096U

#define MSC_MAX_FS_PACKET            0x40U // 0x40=64B
#define MSC_MAX_HS_PACKET            0x200U // 0x200=512B,
...
extern uint8_t USBD_MSC_CfgFSDesc[USB_MSC_CONFIG_DESC_SIZ];
extern uint8_t USBD_MSC_OtherSpeedCfgDesc[USB_MSC_CONFIG_DESC_SIZ];
