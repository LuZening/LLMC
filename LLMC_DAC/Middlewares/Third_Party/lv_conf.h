...
#define LV_USE_STDLIB_SPRINTF   LV_STDLIB_BUILTIN
    ...
    #define LV_MEM_SIZE (100U * 1024U)          /*[100K bytes]*/
...
#define LV_USE_DRAW_SW 1
    ...
    #define LV_USE_NATIVE_HELIUM_ASM    0 // STM32H7 may not support Helium technology
    ...
    #define LV_DRAW_SW_COMPLEX          1
        ...
        *Caching has LV_DRAW_SW_SHADOW_CACHE_SIZE^2 RAM cost*/
        #define LV_DRAW_SW_SHADOW_CACHE_SIZE 0U
...
#define LV_CACHE_DEF_SIZE       24U * 1024U // For 100x100x16b picture

/*Default number of image header cache entries. The cache is used to store the headers of images
 *The main logic is like `LV_CACHE_DEF_SIZE` but for image headers.*/
#define LV_IMAGE_HEADER_CACHE_DEF_CNT 128U
...
#define LV_BIG_ENDIAN_SYSTEM 0 // STM32 is little_endian
...
#define LV_ATTRIBUTE_LARGE_CONST  __attribute__((section(".font")))

/*Compiler prefix for a big array declaration in RAM*/
#define LV_ATTRIBUTE_LARGE_RAM_ARRAY __attribute__((section(".bss")))

/*Place performance critical functions into a faster memory (e.g RAM)*/
#define LV_ATTRIBUTE_FAST_MEM  __attribute__((section(".ITCMRAM_heap")))
...
#define LV_USE_FS_STDIO 0
    ...
    #define LV_FS_STDIO_CACHE_SIZE 64*1024U    /*>0 to cache this number of bytes in lv_fs_read()*/
#endif
...
#define LV_USE_FS_FATFS 1
    ...
    #define LV_FS_FATFS_CACHE_SIZE 4*1024U    /*>0 to cache this number of bytes in lv_fs_read()*/
#endif
...
/*Requires: lv_table*/
#define LV_FILE_EXPLORER_PATH_MAX_LEN        (255)
