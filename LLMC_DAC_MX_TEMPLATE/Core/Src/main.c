...
void PeriphCommonClock_Config(void)
{
  ...
  */
  PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_USB|RCC_PERIPHCLK_I2C1
                              ...
                              |RCC_PERIPHCLK_USART1|RCC_PERIPHCLK_LTDC;
...
static void MX_IWDG1_Init(void)
{
  ...
  hiwdg1.Init.Window = 3888;
  hiwdg1.Init.Reload = 3888;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, NP_EN_Pin|TFT_DISP_Pin|PWR_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(NOCHRG_GPIO_Port, NOCHRG_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DECODER_RSTX_Pin|BK_EN_Pin|SPI1_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LED_MIC2_Pin|LED_MIC1_Pin|T_CSX_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, PREAMP_PD1_Pin|PREAMP_PD2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : NP_EN_Pin TFT_DISP_Pin PWR_EN_Pin */
  ...
  /*Configure GPIO pin : NOCHRG_Pin */
  GPIO_InitStruct.Pin = NOCHRG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(NOCHRG_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = MIC_DETECT2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(MIC_DETECT2_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : OUT2_DETECT_Pin */
  GPIO_InitStruct.Pin = OUT2_DETECT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(OUT2_DETECT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : OUT1_DETECT_Pin */
  GPIO_InitStruct.Pin = OUT1_DETECT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(OUT1_DETECT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : LED_MIC2_Pin LED_MIC1_Pin PREAMP_PD1_Pin PREAMP_PD2_Pin */
  GPIO_InitStruct.Pin = LED_MIC2_Pin|LED_MIC1_Pin|PREAMP_PD1_Pin|PREAMP_PD2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
